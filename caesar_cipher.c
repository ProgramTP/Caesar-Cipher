...
//     tests it means you did not test carefully enough.
   ...
   int t_asc = 0;
   int j = 0;
   if (strlen(password) == 0 || strlen(plaintext) == 0) return;
...
// TO DO: Implement this function
   if (strlen(password) == 0 || strlen(cryptotext) == 0) return;
   int asc = 0;
   int t_asc = 0;
   int j = 0;
...
int main()
{
   ...
   caesar_cipher(&a_passage[0][0],(unsigned char *)"Blueberries are blue");
   caesar_cipher(&a_passage[1][0],(unsigned char *)"Blueberries are blue");
   caesar_cipher(&a_passage[2][0],(unsigned char *)"Blueberries are blue");
   caesar_cipher(&a_passage[3][0],(unsigned char *)"Blueberries are blue");
   caesar_cipher(&a_passage[4][0],(unsigned char *)"Blueberries are blue");
   ...
   caesar_decipher(&a_passage[0][0],(unsigned char *)"Blueberries are blue");
   caesar_decipher(&a_passage[1][0],(unsigned char *)"Blueberries are blue");
   caesar_decipher(&a_passage[2][0],(unsigned char *)"Blueberries are blue");
   caesar_decipher(&a_passage[3][0],(unsigned char *)"Blueberries are blue");
   caesar_decipher(&a_passage[4][0],(unsigned char *)"Blueberries are blue");
